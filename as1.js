...
function main()
{
  ...
  (
    ...
    function(spark)
    {
      ...
      addListener('newproduct',                           'newproduct',                           global.modproducts.NewProduct,                         ['*name', '*productcategoryid', '*code', '*name', 'altcode', 'barcode', 'costprice', 'uom', 'uomsize', 'clientid', 'isactive', 'buytaxcodeid', 'selltaxcodeid', 'costofgoodsaccountid', 'incomeaccountid', 'assetaccountid', 'buildtemplateid', 'minqty', 'warnqty', 'width', 'length', 'height', 'weight', 'price1', 'price2', 'price3', 'price4', 'price5', 'price6', 'price7', 'price8', 'price9', 'price10', 'price11', 'price12', 'atttrib1', 'attrib2', 'attrib3', 'attrib4', 'attrib5', 'productaliasid', 'location1id', 'location2id', 'prices']);
